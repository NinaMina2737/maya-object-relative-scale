...
####################################################################################################
# About module file
_MODULE_FILE_NAME = "objectRelativeScale.mod"
_MODULE_NAME = "objectRelativeScale"
_MODULE_VERSION = "v1.0.0"
_SCRIPTS_DIR_NAME = "src"

# About shelf button
_COMMAND = """import maya_object_relative_scale_ui as scr<COMMAND_NEW_LINE>reload(scr)<COMMAND_NEW_LINE>scr.execute()<COMMAND_NEW_LINE>"""
